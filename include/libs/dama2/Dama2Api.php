 ...
 */
require(ROOT_PATH . 'include/libs/dama2/HttpClient.class.php');
require(ROOT_PATH . 'include/libs/dama2/Dama2Encrypt.php');

class Dama2Api
{

    const APP_KEY = 'bf488c18b615f29e73084b1421779de5';//替换成你的app_key
    const APP_ID  = '51612';//替换你的app_id
